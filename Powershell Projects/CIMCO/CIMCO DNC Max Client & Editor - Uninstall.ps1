...
$appRemoveTable = @{
    ...
    "CIMCO_Client-DNCMAX&Editor_8.09.07" = "{66AFD3DB-B0D5-4EA4-BEE8-7AED2D14A966}"
...
$sh1 = "C:\Program Files (x86)\CIMCO\DNCMax8\cfg\DNCAdm.ini"
...
#Delete Orphaned files If Exists
$sh2 = "C:\Program Files (x86)\CIMCO\DNCMax8"
