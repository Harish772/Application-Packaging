...
$OldAppDetection1 = "C:\SIMULIA\fe-safe\2018\win_b64\code\bin\fe-safe.exe"
$OldAppDetection2 = "C:\SIMULIA\fe-safe\2018\win_b64\code\bin\CATSTART.exe"
...
$procstartinfo.FileName = "$scriptpath\Source\2018-Uninstall\FE-Safe_Uninstaller.EXE"
