...
$OldAppDetection1 = "C:\SIMULIA\Tosca\2018\win_b64\SMATfoResources\gui\TFluid.exe"
$OldAppDetection2 = "C:\SIMULIA\Tosca\2018\win_b64\code\bin\SMAExternal\ToscaView\tosca_view.exe"
...
$procstartinfo.FileName = "$scriptpath\Source\2018-Uninstall\Tosca_Uninstaller.EXE"
