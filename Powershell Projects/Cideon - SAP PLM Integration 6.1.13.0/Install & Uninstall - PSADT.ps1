...
Try {
	...
	[string]$appVendor = 'Cideon'
	[string]$appName = 'SAP PLM Integration'
	[string]$appVersion = '6.1.13.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '9/5/2020'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## <Perform Pre-Installation tasks here>
           ...
           ####+++++++++++++++ Following lines of script uninstalls previous version of the SAP PLM Integration if found. If not, its proceeds to next instance ++++++#####

           Execute-MSI -Action 'Uninstall' -Path "{EFF043FD-F9AF-11D3-B32C-20705A3B10A2}"
           Execute-MSI -Action 'Uninstall' -Path "{EFF043FD-F9AF-11D3-B32C-20705A3B10A4}"
           Execute-MSI -Action 'Uninstall' -Path "{EFF043FD-F9AF-11D3-B32C-20705A3B10A7}"
        ...
        Execute-MSI -Action 'Install' -Path "SAP PLM Interface to SOLIDWORKS.msi" -Transform '1033.Mst'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        Show-InstallationProgress
         ...
         Execute-MSI -Action 'uninstall' -Path "{EFF043FD-F9AF-11D3-B32C-20705A3B10A9}"
