...
# You need to have RSAT Tools installed on this Machine or Get-Adcomputer won't work
#During this it dynamically loads the module into Memory and Jefferey kinda calls it Virtual Modules
